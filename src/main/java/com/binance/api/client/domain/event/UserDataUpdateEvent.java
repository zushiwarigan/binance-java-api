...
public class UserDataUpdateEvent {
    ...
    public void setDupEvent(DupEvent dupEvent) {
        this.dupEvent = dupEvent;
    }
    ...
    public enum UserDataUpdateEventType {
        ...
        public static UserDataUpdateEventType fromEventTypeId(String eventTypeId) {
            ...
            throw new IllegalArgumentException("Unrecognized user data update event type id: " + eventTypeId+", "+BALANCE_UPDATE.eventTypeId.equals(eventTypeId));
        }
    }
}
